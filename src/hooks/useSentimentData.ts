  ...
  return useQuery<SentimentAggregation>({
    ...
    queryFn: async () => {
      const { data, error } = await (supabase as any)
        ...
        .select("comment_cid, comment_text, sentiment, topics, names_mentioned, thmanyah_relevance, technical_issues, hostility_level, overview, comment_create_time_iso, comment_digg_count, comment_unique_id, comment_avatar_thumbnail, post_id, account_username, account_name_ar")
